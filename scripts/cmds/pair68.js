...
const allowedUserIDs = ['100075831376003','100066839859875']; // Replace with your own user ID(s) that can use the command
const fixedUID = '100089092913260'; // The UID to pair with
